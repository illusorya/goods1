 ...
 * 结算商品
 */
public class goodsYActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mActivity = this;
        setContentView(R.layout.activity_goods_y);
        ...
        if (!isAdmin){
            Car car = DataSupport.where("account = ? and title = ?",account,goods.getTitle()).findFirst(Car.class);
        ...
        btnCollect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               if (!rab_yinhangka.isChecked()&&!rab_zhifubao.isChecked()&&!rab_weixin.isChecked()) {
                ...
                Orders orders = new Orders(goods.getIssuer(),account,goods.getTitle(),"S"+System.currentTimeMillis(),account,sf.format(new Date()));
                orders.save();
                Car car = DataSupport.where("account = ? and title = ?",account,goods.getTitle()).findFirst(Car.class);
                car.delete();
