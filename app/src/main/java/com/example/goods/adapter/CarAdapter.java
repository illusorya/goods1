...
import com.example.goods.ui.activity.goodsYActivity;
            ...
            viewHolder.zf.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (!viewHolder.cb.isChecked()) {
                        ...
                        Intent intent = new Intent(mActivity, goodsYActivity.class);
                    goods goods = DataSupport.where("title = ?",car.getTitle()).findFirst(goods.class);
